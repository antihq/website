...
<flux:button
    ...
    "
>
    <flux:icon.eye-slash variant="micro" class="hidden size-5 sm:size-4 [[data-viewable-open]>&]:block" />
    <flux:icon.eye variant="micro" class="block size-5 sm:size-4 [[data-viewable-open]>&]:hidden" />
</flux:button>
