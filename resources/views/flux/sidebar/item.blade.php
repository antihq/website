...
$classes = Flux::classes()
    ->add('px-2 h-11 relative flex items-center gap-3 rounded-lg sm:h-9')
    ...
    <flux:button-or-link :attributes="$attributes->class($classes)" data-flux-sidebar-item>
        ...
        <?php if ($slot->isNotEmpty()): ?>
            <div class="
                ...
                flex-1 text-base/6 font-medium whitespace-nowrap sm:text-sm/5 [[data-nav-footer]_&]:hidden [[data-nav-sidebar]_[data-nav-footer]_&]:block" data-content>{{ $slot }}</div>
        <?php endif; ?>
