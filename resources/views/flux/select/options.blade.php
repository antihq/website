...
<?php else: ?>
    <div popover="manual" class="[:where(&)]:min-w-48 [&:popover-open]:flex [&:popover-open]:flex-col rounded-xl shadow-lg ring-1 ring-zinc-950/10 dark:ring-white/10 dark:ring-inset bg-white dark:bg-zinc-800 p-[.3125rem]" data-flux-options>
