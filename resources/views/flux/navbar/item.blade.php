...
<flux:button-or-link :attributes="$attributes->class($classes)" data-flux-navbar-items>
    ...
    <?php if ($slot->isNotEmpty()): ?>
        <div class="{{ $icon ? 'ms-3' : '' }} flex-1 text-base/6 font-medium whitespace-nowrap sm:text-sm/5 [[data-nav-footer]_&]:hidden [[data-nav-sidebar]_[data-nav-footer]_&]:block" data-content>{{ $slot }}</div>
    <?php endif; ?>
